  ...
  function(JSZip, Deck, ImpressRenderer, FileUtils) {
    ...
    return Archiver = (function() {
      ...
      Archiver.prototype.create = function() {
        ...
        showStr = "<!doctype html><html>" + ImpressRenderer.render(presentationCopy) + "</html>";
      ...
      Archiver.prototype.createSimple = function(cb, opts) {
        ...
        this.archive = new JSZip();
        this.previewExportDir = this.archive.folder("preview_export");
        showStr = '<body class="impress-not-supported">' + ImpressRenderer.render(_this.presentation) + '\n<div id="launched-placeholder"></div>\n</body>';
        return $.get('preview_export/impress_zip.html', function(impress) {
          var htmlStr = impress.replace(/\<body[^]*?\>[^]*?\<\/body\>/m,showStr);
          _this.previewExportDir.file("index.html", htmlStr);
      ...
      Archiver.prototype._archiveCss = function(cb) {
        var _this = this;
        return $.get('preview_export/css/main.css', function(css) {
